...
const SidebarLayout = ({ children }: SidebarLayoutProps) => {
  ...
  return (
    <div className="h-screen flex overflow-hidden bg-gray-100">
      ...
      <div 
        className={`md:hidden fixed inset-0 z-40 bg-gray-600 bg-opacity-75 transition-opacity ease-linear duration-300 ${
      ...
      {/* Mobile sidebar */}
      <div
        className={`fixed inset-y-0 left-0 flex flex-col z-50 md:hidden transition-transform duration-300 ease-in-out transform ${
